    ...
    <div className="space-y-8">
        ...
        <div className="dash-panel p-6 sm:p-8">
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-xl font-bold text-gray-800">
              {editingArea ? 'Edit Area of Work' : 'Add Area of Work'}
            </h3>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  ...
                  className="block w-full rounded-lg border-gray-300 bg-gray-50 p-2.5 text-sm focus:border-green-500"
                  required
                />
              </div>
              <div>
              ...
              <div className="md:col-span-2">{/* Description removed as requested */}</div>
              ...
              <div className="md:col-span-2">
                ...
                {editingArea && !selectedFile && (
                  <div className="mt-2">
                    ...
                    <img src={editingArea.image} alt="Current" className="h-16 rounded mt-1" />
                  </div>
                )}
              </div>
            </div>
            <div className="flex gap-4">
              <button
                type="submit"
                disabled={uploading}
                className="px-6 py-2.5 rounded-lg font-semibold text-white bg-green-600 hover:bg-green-700 disabled:bg-gray-400"
              >
      ...
      <div className="dash-panel overflow-hidden">
        <div className="dash-panel-head">
          <div>
            <h3 className="text-base font-semibold text-slate-900">Areas of Work</h3>
            <p className="text-sm text-gray-500">Manage areas of work section</p>
          </div>
          {!showCreateForm && (
            <button
              onClick={() => setShowCreateForm(true)}
              className="px-4 py-2 bg-green-600 text-white rounded-lg font-semibold hover:bg-green-700 flex gap-2"
            >
              Add New
            </button>
          )}
        ...
        {areas.length === 0 ? (
          <div className="p-12 text-center text-gray-500">No areas found.</div>
        ) : (
