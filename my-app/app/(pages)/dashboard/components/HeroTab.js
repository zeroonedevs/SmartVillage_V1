  ...
  const handleSubmit = async e => {
    ...
    try {
      ...
      if (saveData.success) {
        ...
        cancelForm();
        toast.success(
          editingSlide ? 'Hero slide updated successfully!' : 'Hero slide added successfully!'
        );
      } else {
        ...
        <div className="dash-panel p-6 sm:p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>{/* Subtitle removed as requested */}</div>
              <div>
                  ...
                  <tr key={item._id} className="hover:bg-gray-50/80 transition-colors">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                      <button
                        ...
                        className="text-blue-600 hover:text-blue-800 p-2 hover:bg-blue-50 rounded-lg mr-2"
                      >
                        Edit
                      </button>
                      <button
