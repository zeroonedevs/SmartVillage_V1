    ...
    <div className="space-y-8">
      ...
      <div className="dash-panel p-6 sm:p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="md:col-span-2">
              <label className="block text-sm font-semibold text-gray-700 mb-2">
                Report File (PDF only, Max 3MB)
              </label>
              <div className="flex items-center justify-center w-full">
                <label
                  htmlFor="report-upload"
                  className="flex flex-col items-center justify-center w-full h-32 border-2 border-gray-300 border-dashed rounded-xl cursor-pointer bg-gray-50 hover:bg-gray-100 hover:border-green-400 transition-all"
                >
          ...
          {error && (
            <p className="text-red-500 text-sm mt-2 text-center bg-red-50 py-2 rounded">{error}</p>
          )}
        </form>
      </div>
      ...
      <div className="dash-panel overflow-hidden">
        <div className="dash-panel-head">
          <div>
            <h3 className="text-base font-semibold text-slate-900">Activity Reports</h3>
                ...
                {activities.map(activity => (
                  <tr key={activity._id} className="hover:bg-gray-50/80 transition-colors">
                    ...
                    <td className="px-6 py-4 text-sm text-gray-600 font-medium">
                      {activity.studentsParticipated} Students
                    </td>
