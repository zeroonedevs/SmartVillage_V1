            ...
            {registrations.map(reg => (
              <tr key={reg._id} className="hover:bg-gray-50/80 transition-colors">
                ...
                <td className="px-6 py-4">
                  ...
                  <div className="text-xs text-blue-600 bg-blue-50 inline-block px-1.5 py-0.5 rounded mt-0.5 mb-1 font-medium">
                    {reg.designation}
                  </div>
                  ...
                  <div className="flex flex-wrap gap-1.5 max-w-xs">
                    {reg.interestedDomains && reg.interestedDomains.length > 0 ? (
                      reg.interestedDomains.map((domain, idx) => (
                        <span
                          key={idx}
                          className="bg-gray-100 text-gray-600 text-xs px-2.5 py-1 rounded-md border border-gray-200 font-medium"
                        >
                          {domain}
                        </span>
                      ))
