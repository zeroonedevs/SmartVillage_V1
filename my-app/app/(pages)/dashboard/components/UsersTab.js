    ...
    <div className="space-y-8">
      ...
      <div className="dash-panel overflow-hidden">
        <div className="dash-panel-head">
          <div>
            <h3 className="text-base font-semibold text-slate-900">Users Management</h3>
              ...
              <tbody className="bg-white divide-y divide-gray-100">
                {users.map(user => (
                  <tr key={user._id} className="hover:bg-gray-50/80 transition-colors">
                    ...
                    <td className="px-6 py-4 text-sm">
                      <span
                        className={`px-2.5 py-0.5 rounded-md text-xs font-semibold border ${getRoleBadgeColor(user.role)}`}
                      >
