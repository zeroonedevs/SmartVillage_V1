            ...
            <table className="w-full border-collapse">
              <thead>
                <tr>
                  ...
                  <th className="bg-[#008000] text-white font-bold p-3 border border-green-700 w-[35%] text-left">
                    Village Name
                  </th>
                  <th className="bg-[#008000] text-white font-bold p-3 border border-green-700 w-[25%] text-left">
                    Mandal
                  </th>
                  <th className="bg-[#008000] text-white font-bold p-3 border border-green-700 w-[30%] text-left">
                    District
                  </th>
                </tr>
              </thead>
              <tbody>
                {currentItems.length > 0 ? (
                  ...
                  <tr>
                    <td
                      colSpan="4"
                      className="border border-green-700 text-center p-8 text-gray-500 italic"
                    >
                      No villages found.
                    </td>
                  </tr>
