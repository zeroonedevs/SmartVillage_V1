          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12">
            ...
            <div className="max-w-2xl text-center lg:text-left z-20">
              ...
              <p className="text-lg md:text-xl text-white max-w-xl mx-auto lg:mx-0 leading-relaxed font-light mb-8">
                Our gallery is a tribute to the countless memories, community efforts, and village
                transformations we've achieved together.
              </p>
            </div>
          </div>
        </div>
        ...
        {loading ? (
          ...
          <div className="space-y-8">
            ...
            {filteredImages.length > 0 ? (
              <div className="">
                <MultiImageDisplay imagePaths={currentImages} groupByDomain={false} />
              </div>
            ) : (
