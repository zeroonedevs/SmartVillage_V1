...
function StaffPage() {
  ...
  const filteredStaff = staffList.filter(staff =>
    Object.values(staff).some(val => String(val).toLowerCase().includes(searchQuery.toLowerCase()))
  );
            ...
            <table className="w-full border-collapse">
              <thead>
                <tr>
                  ...
                  <th className="bg-[#008000] text-white font-bold p-3 border border-green-700 w-[50%] text-left">
                    Name of the Staff
                  </th>
                  <th className="bg-[#008000] text-white font-bold p-3 border border-green-700 w-[40%] text-left">
                    Designation
                  </th>
                </tr>
              </thead>
