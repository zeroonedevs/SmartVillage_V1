          ...
          <g transform="translate(-589.000000, -2185.000000)" stroke="green" strokeWidth={4}>
            <g transform="translate(591.000000, 2187.000000)">
              <g className="stems">
                <path
                  className="main-stem"
                  d="M133.4414,160.118 L133.4414,31.451"
                  id="Stroke-7"
                ></path>
                <path
                  className="outer-stems"
                  style={{ WebkitTransitionDelay: '1s', transitionDelay: '1s' }}
              ...
              <g className="ground">
                <path
                  d="M64.0483,188.6473 C70.1213,172.4103 98.5983,160.1183 132.8343,160.1183 C167.8373,160.1183 196.8373,172.9633 202.0113,189.7403"
                  id="Stroke-35"
                ></path>
              </g>
            </g>
