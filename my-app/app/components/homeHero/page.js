    ...
    <div className="hero">
      ...
      <div className="hero-header">
        ...
        <div className="hero-svr-box">
          <Image src={SVRLogo} className="hero-svr-logo" width={70} height={70} alt="SVR Logo" />
            ...
            {images.map((image, index) => (
              <SwiperSlide key={index}>
                <div className="hero-in-slider">
                  <img className="home-hero-images" src={image.url} alt={`Image ${index}`} />
